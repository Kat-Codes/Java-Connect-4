...
/**
 * 
 * Takes an input from the keyboard and checks for exceptions 
 * before calling the move() method in MyGameState to drop a 
 * counter into the board
 */
...
public class KeyboardPlayer extends Connect4Player {
	...
	public void makeMove(Connect4GameState gameState) {
			...
			//if the user inputs an incorrect input, they are given other chance
			} while (!validInput);
			return;
	}
